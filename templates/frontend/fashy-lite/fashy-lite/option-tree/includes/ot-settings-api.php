    ...
    public function display_page() {
      ...
      foreach( (array) $this->options as $option ) {
            ...
            echo '<div class="wrap settings-wrap" id ="page-' . $page['id'] . '">';
              ...
              echo '<h2>' . $theme->get( 'Name' ) .' '. $page['page_title'] . '</h2>';
				...
				$updater = new EDD_Theme_Updater_Admin(
					...
					// Strings
					$strings = array(
						'theme-license' => __( 'Theme License', 'fashy' ),
						'enter-key' => __( 'Enter your theme license key.', 'fashy' ),
						'license-key' => __( 'License Key', 'fashy' ),
						'license-action' => __( 'License Action', 'fashy' ),
						'deactivate-license' => __( 'Deactivate License', 'fashy' ),
						'activate-license' => __( 'Activate License', 'fashy' ),
						'status-unknown' => __( 'License status is unknown.', 'fashy' ),
						'renew' => __( 'Renew?', 'fashy' ),
						'unlimited' => __( 'unlimited', 'fashy' ),
						'license-key-is-active' => __( 'License key is active.', 'fashy' ),
						'expires%s' => __( 'Expires %s.', 'fashy' ),
						'%1$s/%2$-sites' => __( 'You have %1$s / %2$s sites activated.', 'fashy' ),
						'license-key-expired-%s' => __( 'License key expired %s.', 'fashy' ),
						'license-key-expired' => __( 'License key has expired. You will not receive updates and you can no longer use support. We recommend you to update the licence so your theme will be up to date in the future.', 'fashy' ),
						'license-keys-do-not-match' => __( 'License keys do not match.', 'fashy' ),
						'license-is-inactive' => __( 'License is inactive.', 'fashy' ),
						'license-key-is-disabled' => __( 'License key is disabled.', 'fashy' ),
						'site-is-inactive' => __( 'Site is inactive.', 'fashy' ),
						'license-status-unknown' => __( 'License status is unknown.', 'fashy' ),
						'update-notice' => __( "Updating this theme will lose any customizations you have made. 'Cancel' to stop, 'OK' to update.", 'fashy' ),
						'update-available' => __('<strong>%1$s %2$s</strong> is available. <a href="%3$s" class="thickbox" title="%4s">Check out what\'s new</a> or <a href="%5$s"%6$s>update now</a>.', 'fashy' )
					)

				);		
				$updater ->license_page(); 	
				echo '		<h2>Lite version of Fashy theme</h2>
		...
		<li>Premium support</li>		
				...
				echo '		<a class="buy-freya button" title = "Click to check out the Premium Version" href ="https://premiumcoding.com/wordpress-themes/fashy-wordpress-fashion-blog-theme/" target = "_blank">Buy Fashy now and save 20% with discount code "fashylite"</a>';
				echo '</div>';
              ...
              echo '<div id="option-tree-header-wrap">';
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<li id="option-tree-version"><span>' . $theme->get( 'Name' ) . ' '. esc_attr__('Version: ','fashy') . $theme->get( 'Version' ).'</span></li>';
